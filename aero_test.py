...
class TestAerolinea(unittest.TestCase):
	...
	def test_aerolinea_2(self):
		"""CE1
		Vuelo internacional, Europa, 1 adultos y 1 nino, Enero, economica"""
		boleto1 = pasajero.Pasajero('Adulto', 'Internacional', 'Europa', 1, 'economica')
		boleto2 = pasajero.Pasajero('Niño', 'Internacional', 'Europa', 1, 'economica')
		lista_pasajero = [boleto1,boleto2]
		valor_total = calculo_funciones.obtener_total(lista_pasajero)
		self.assertEqual(valor_total, 945.00)

	def test_aerolinea_3(self):
		"""CE2
		Vuelo internacional, Europa, 2 adultos y 2 nino, Septiembre, economica"""
		...
		boleto4 = pasajero.Pasajero('Niño', 'Internacional', 'Europa', 9, 'economica')
		lista_pasajero = [boleto1,boleto2,boleto3,boleto4]
		valor_total = calculo_funciones.obtener_total(lista_pasajero)
		self.assertEqual(valor_total, 2016.00)
